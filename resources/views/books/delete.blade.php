...
<div class="card-header">Books Data</div>
    <div class="card-body">
        <form method="POST" action="{{ route('books.destroy', $book->isbn) }}" onsubmit="return confirm('Apakah Anda yakin ingin menghapus buku ini?');">
            @method('DELETE')
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="price" name="price" value="{{$book->price}}" disabled>
